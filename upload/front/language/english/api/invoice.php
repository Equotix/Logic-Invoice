<?php
// Text
$_['text_added']			= '[Invoice] Invoice #%s added by %s.';
$_['text_edited']			= '[Invoice] Invoice #%s edited by %s.';
$_['text_updated']			= '[Invoice] Invoice #%s status updated to %s by %s.';

// Error
$_['error_invoice_id']	 	= 'Invoice ID must be specified.';
...
$_['error_status_id']		= 'Status ID must be specified.';
