...
class ControllerPaymentPPStandardPPStandard extends Controller {
    public function index() {
        ...
        if ($invoice_info) {
            ...
            $this->data['return'] = $this->url->link('account/invoice/success', 'invoice_id=' . $invoice_info['invoice_id'], 'SSL');
            $this->data['notify_url'] = $this->url->link('payment/pp_standard/pp_standard/callback', '', 'SSL');
            $this->data['cancel_return'] = $this->url->link('account/invoice/payment', 'invoice_id=' . $invoice_info['invoice_id'], 'SSL');
