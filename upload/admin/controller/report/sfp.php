...
class ControllerReportSFP extends Controller {
    ...
    public function index() {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('report/sfp', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        $this->data['print'] = $this->url->link('report/sfp', 'token=' . $this->session->data['token'] . '&print_version=1' . $url, 'SSL');
