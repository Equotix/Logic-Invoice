    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
          ...
          <td class="text-left">
            <select name="<?php echo $extension['code']; ?>_status" class="form-control input-sm status"<?php echo $extension['installed'] ? '' : ' disabled'; ?>>
          ...
          <td class="text-left">
            <input type="text" name="<?php echo $extension['code']; ?>_sort_order" value="<?php echo $extension['sort_order']; ?>" class="form-control input-sm sort-order" <?php echo $extension['installed'] ? '' : ' disabled'; ?> />
          </td>
