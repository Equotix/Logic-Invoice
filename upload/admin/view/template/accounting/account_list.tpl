    ...
    <form method="post" action="<?php echo $delete; ?>" id="form-account">
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr>
            <th class="text-left" colspan="7"><?php echo $text_assets; ?></th>
          </tr>
          <?php $header = 'asset'; ?>
          <?php } ?>
          <?php if (in_array($account['type'], $equity) && $header != 'equity') { ?>
          <tr>
            <th class="text-left" colspan="7"><?php echo $text_equity; ?></th>
          </tr>
          <?php $header = 'equity'; ?>
          <?php } ?>
          <?php if (in_array($account['type'], $expense) && $header != 'expense') { ?>
          <tr>
            <th class="text-left" colspan="7"><?php echo $text_expenses; ?></th>
          </tr>
          <?php $header = 'expense'; ?>
          <?php } ?>
          <?php if (in_array($account['type'], $liability) && $header != 'liability') { ?>
          <tr>
            <th class="text-left" colspan="7"><?php echo $text_liabilities; ?></th>
          </tr>
          <?php $header = 'liability'; ?>
          <?php } ?>
          <?php if (in_array($account['type'], $revenue) && $header != 'revenue') { ?>
          <tr>
            <th class="text-left" colspan="7"><?php echo $text_revenue; ?></th>
          </tr>
          <?php $header = 'revenue'; ?>
          <?php } ?>
          <tr>
