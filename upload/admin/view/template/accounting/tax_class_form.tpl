...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="pull-right">
      <button type="submit" form="form-tax-class" title="<?php echo $button_save; ?>" data-toggle="tooltip" class="btn btn-success">
  ...
  <div class="panel-body">
    <form method="post" action="<?php echo $action; ?>" id="form-tax-class" class="form-horizontal">
      ...
      <table id="tax-rates" class="table table-striped table-bordered table-hover">
        ...
        <tr>
          <td class="text-left">
            <select name="tax_rates[<?php echo $tax_rate_row; ?>][tax_rate_id]" class="form-control">
          ...
          <td class="text-left">
            <input type="text" name="tax_rates[<?php echo $tax_rate_row; ?>][priority]" value="<?php echo $tax_rate['priority']; ?>" class="form-control" />
          </td>
          <td class="text-right">
...
<script type="text/javascript"><!--
  ...
  <
  ...
  )
    {
      ?
    >
      html += '    <option value="<?php echo $rate['
      tax_rate_id
      ']; ?>"><?php echo $rate['
      name
      ']; ?></option>';
