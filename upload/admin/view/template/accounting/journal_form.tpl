    ...
    <form method="post" action="<?php echo $action; ?>" id="form-journal" class="form-horizontal">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr>
            <td class="text-left">
              <select name="transaction_accounts[<?php echo $transaction_row; ?>][account_id]" class="form-control">
                <optgroup>
                  <?php $header = ''; ?>
            ...
            <td class="text-right">
              <button type="button" title="<?php echo $button_remove; ?>" data-toggle="tooltip" class="btn btn-danger btn-xs" onclick="$(this).parents('tr').remove();">
          ...
          <tr id="transaction-add">
            <td colspan="4" class="text-right">
              <button type="button" title="<?php echo $button_add; ?>" data-toggle="tooltip" class="btn btn-success btn-xs" onclick="addTransaction();">
...
<script type="text/javascript"><!--
  ...
  <
    ...
    <
      ? php
      if (in_array($account['type'], $asset) && $header != 'asset') {
        ?
      >
    ...
    <
      ? php
      if (in_array($account['type'], $equity) && $header != 'equity') {
        ?
      >
    ...
    <
      ? php
      if (in_array($account['type'], $expense) && $header != 'expense') {
        ?
      >
    ...
    <
      ? php
      if (in_array($account['type'], $liability) && $header != 'liability') {
        ?
      >
    ...
    <
      ? php
      if (in_array($account['type'], $revenue) && $header != 'revenue') {
        ?
      >
      ...
      ?
    >
      html += '<option value="<?php echo $account['
      account_id
      ']; ?>"<?php echo $account['
      children
      '] ? '
    ...
    <
    ...
    )
      {
        ?
      >
        html += '<option value="<?php echo $child['
        account_id
        ']; ?>"<?php echo $child['
        grandchildren
        '] ? '
        ...
        ']; ?></option>';
      <
        ? php foreach($child['grandchildren']
        as
        $grandchild
      )
        {
          ?
        >
          html += '<option value="<?php echo $grandchild['
          account_id
          ']; ?>"><?php echo $grandchild['
          name
          ']; ?></option>';
