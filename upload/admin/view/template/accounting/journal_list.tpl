...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="pull-right">
      ...
      <button type="button" title="<?php echo $button_delete; ?>" data-toggle="tooltip" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-journal').submit() : false;">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr class="filter">
            <td></td>
            <td class="text-left">
              <input type="text" name="filter_description" value="<?php echo $filter_description; ?>" class="form-control input-sm" />
            </td>
            <td class="text-left">
              <input type="text" name="filter_invoice_id" value="<?php echo $filter_invoice_id; ?>" class="form-control input-sm" />
            </td>
            <td class="text-left">
              <input type="text" name="filter_date" value="<?php echo $filter_date; ?>" class="form-control input-sm date" data-date-format="YYYY-MM-DD" />
            </td>
            <td class="text-right">
