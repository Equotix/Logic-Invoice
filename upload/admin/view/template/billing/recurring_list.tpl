  ...
  <div class="panel-heading">
    <div class="pull-right">
      ...
      <button type="button" title="<?php echo $button_delete; ?>" data-toggle="tooltip" class="btn btn-danger" onclick="$('#form-recurring').attr('action', '<?php echo $delete; ?>');
              confirm('<?php echo $text_confirm; ?>') ? $('#form-recurring').submit() : false;">
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr class="filter">
            ...
            <td class="text-left col-sm-1">
              <input type="text" name="filter_recurring_id" value="<?php echo $filter_recurring_id; ?>" class="form-control input-sm" />
            </td>
            ...
            <td class="text-right col-sm-1">
              <input type="text" name="filter_date_added" value="<?php echo $filter_date_added; ?>" class="form-control input-sm date" data-date-format="YYYY-MM-DD" />
            </td>
            <td class="text-right col-sm-1">
          ...
          <tr>
            ...
            <td class="text-left"><a href="<?php echo $recurring['customer']; ?>"><?php echo $recurring['name']; ?></a>
            </td>
            <td class="text-left"><?php echo $recurring['total']; ?></td>
            <td class="text-left">
              <select name="<?php echo $recurring['recurring_id']; ?>" class="form-control input-sm status">
            ...
            <td class="text-right">
              <a href="<?php echo $recurring['edit']; ?>" title="<?php echo $button_edit; ?>" data-toggle="tooltip" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
