...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="pull-right">
      <button type="submit" form="form-quotation" title="<?php echo $button_save; ?>" data-toggle="tooltip" id="button-save" class="btn btn-success disabled total"><i class="fa fa-save"></i></button>
  ...
  <div class="panel-body">
    <form method="post" action="<?php echo $action; ?>" class="form-horizontal" id="form-quotation">
          ...
          <div class="table-responsive">
            <table id="items" class="table table-striped table-bordered table-hover">
              ...
              <tr>
                ...
                <td class="text-right">
                  <div><input type="text" name="items[<?php echo $item_row; ?>][converted_price]" value="<?php echo $item['converted_price']; ?>" class="form-control converted" placeholder="0.00" /> (<span class="quotation-currency"><?php echo $currency_code; ?></span>)</div>
                ...
                <td class="text-right">
                  <div><input type="text" name="items[<?php echo $item_row; ?>][converted_discount]" value="<?php echo $item['converted_discount']; ?>" class="form-control converted" placeholder="0.00" /> (<span class="quotation-currency"><?php echo $currency_code; ?></span>)</div>
                  <div class="text-center">=</div>
...
$(document).ready(function () {
	...
	$('#input-currency-code').change(function () {
		$.ajax({
			...
			success: function (currency) {
				...
				$('.quotation-currency').html(currency['code']);
	...
	$('#button-forward-step-1').click(function () {
		$.ajax({
			url: 'index.php?load=billing/quotation/validate_step_1&token=<?php echo $token; ?>',
	...
	$('#button-forward-step-3').click(function () {
		$.ajax({
			url: 'index.php?load=billing/quotation/validate_step_3&token=<?php echo $token; ?>',
	...
	$('#button-forward-step-4').click(function () {
		$.ajax({
			url: 'index.php?load=billing/quotation/validate_step_4&token=<?php echo $token; ?>',
			type: 'post',
			data: $('#form-quotation input, #form-quotation textarea, #form-quotation select'),
			dataType: 'json',
			beforeSend: function () {
...
function addRow() {
	...
	html += '    <div><input type="text" name="items[' + item_row + '][converted_price]" value="" class="form-control converted" placeholder="0.00" /> (<span class="quotation-currency">' + currency_code + '</span>)</div>';
	...
	html += '  <td class="text-right">';
	html += '    <div><input type="text" name="items[' + item_row + '][converted_discount]" value="" class="form-control converted" placeholder="0.00" /> (<span class="quotation-currency">' + currency_code + '</span>)</div>';
	html += '    <div class="text-center">=</div>';
