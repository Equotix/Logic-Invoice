  ...
  <div class="panel-heading">
    <div class="pull-right">
      <button type="button" title="<?php echo $button_transaction; ?>" data-toggle="tooltip" class="btn btn-primary" onclick="$('#form-invoice').attr('action', '<?php echo $transaction; ?>');
              confirm('<?php echo $text_confirm; ?>') ? $('#form-invoice').submit() : false;">
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr class="filter">
            ...
            <td class="text-left col-sm-1">
              <input type="text" name="filter_invoice_id" value="<?php echo $filter_invoice_id; ?>" class="form-control input-sm" />
            </td>
            <td class="text-left col-sm-3">
              <input type="text" name="filter_name" value="<?php echo $filter_name; ?>" class="form-control input-sm" />
            </td>
            <td class="text-left col-sm-1">
              <input type="text" name="filter_total" value="<?php echo $filter_total; ?>" class="form-control input-sm" />
            </td>
            ...
            <td class="text-right col-sm-1">
              <input type="text" name="filter_date_due" value="<?php echo $filter_date_due; ?>" class="form-control input-sm date" data-date-format="YYYY-MM-DD" />
            </td>
            <td class="text-right col-sm-1">
              <input type="text" name="filter_date_issued" value="<?php echo $filter_date_issued; ?>" class="form-control input-sm date" data-date-format="YYYY-MM-DD" />
            </td>
            <td class="text-right col-sm-1">
              <input type="text" name="filter_date_modified" value="<?php echo $filter_date_modified; ?>" class="form-control input-sm date" data-date-format="YYYY-MM-DD" />
            </td>
            <td class="text-right col-sm-1">
              <button type="button" title="<?php echo $button_search; ?>" data-toggle="tooltip" class="btn btn-primary btn-xs" onclick="filter();">
          ...
          <tr>
            ...
            <td class="text-left">
              <select name="<?php echo $invoice['invoice_id']; ?>" class="form-control input-sm status"><?php foreach ($statuses as $status) { ?>
            ...
            <td class="text-center">
              <a href="<?php echo $invoice['transaction_href']; ?>"><?php if ($invoice['transaction']) { ?>
            ...
            <td class="text-right">
              <a href="<?php echo $invoice['edit']; ?>" title="<?php echo $button_edit; ?>" data-toggle="tooltip" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
