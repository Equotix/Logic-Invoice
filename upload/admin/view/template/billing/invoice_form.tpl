...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="pull-right">
      <button type="submit" form="form-invoice" title="<?php echo $button_save; ?>" data-toggle="tooltip" id="button-save" class="btn btn-success disabled total">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab-general">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="firstname" value="<?php echo $firstname; ?>" id="input-firstname" class="form-control" placeholder="<?php echo $entry_firstname; ?>" required />
            </div>
          </div>
          <div class="form-group">
        ...
        <div class="tab-pane" id="tab-payment-method">
          ...
          <div class="pull-right">
            <button type="button" id="button-forward-step-3" class="btn btn-primary">
              <i class="fa fa-arrow-circle-o-right"></i></button>
          </div>
        </div>
        <div class="tab-pane" id="tab-item">
          <div class="table-responsive">
            <table id="items" class="table table-striped table-bordered table-hover">
              ...
              <tr>
                ...
                <td class="text-right">
                  <div>
                    <input type="text" name="items[<?php echo $item_row; ?>][converted_price]" value="<?php echo $item['converted_price']; ?>" class="form-control converted" placeholder="0.00" /> (<span class="invoice-currency"><?php echo $currency_code; ?></span>)
                  </div>
                ...
                <td class="text-right">
                  <div>
                    <input type="text" name="items[<?php echo $item_row; ?>][converted_discount]" value="<?php echo $item['converted_discount']; ?>" class="form-control converted" placeholder="0.00" /> (<span class="invoice-currency"><?php echo $currency_code; ?></span>)
                  </div>
                  <div class="text-center">=</div>
                  <div>
          ...
          <div class="pull-right">
            <button type="button" id="button-forward-step-4" class="btn btn-primary"><?php echo $button_calculate; ?>
              <i class="fa fa-arrow-circle-o-right"></i></button>
          </div>
        </div>
        <div class="tab-pane" id="tab-total">
          ...
          <div class="pull-left">
            <button type="button" id="button-back-step-5" class="btn btn-primary">
              <i class="fa fa-arrow-circle-o-left"></i></button>
          </div>
        </div>
      </div>
