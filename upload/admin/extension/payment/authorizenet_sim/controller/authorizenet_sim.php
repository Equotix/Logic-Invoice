...
class ControllerPaymentAuthorizenetSimAuthorizenetSim extends Controller {
    ...
    public function index() {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('payment/authorizenet_sim/authorizenet_sim', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        $this->data['action'] = $this->url->link('payment/authorizenet_sim/authorizenet_sim', 'token=' . $this->session->data['token'], 'SSL');
