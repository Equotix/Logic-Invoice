...
class ControllerPaymentBankTransferBankTransfer extends Controller {
    ...
    public function index() {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('payment/bank_transfer/bank_transfer', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        $this->data['action'] = $this->url->link('payment/bank_transfer/bank_transfer', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->render('payment/bank_transfer/bank_transfer.tpl'));
    }
