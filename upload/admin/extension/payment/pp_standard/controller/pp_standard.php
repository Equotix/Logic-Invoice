...
class ControllerPaymentPPStandardPPStandard extends Controller {
    ...
    public function index() {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('payment/pp_standard/pp_standard', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        $this->data['action'] = $this->url->link('payment/pp_standard/pp_standard', 'token=' . $this->session->data['token'], 'SSL');
