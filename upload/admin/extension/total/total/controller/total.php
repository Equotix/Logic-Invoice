...
class ControllerTotalTotalTotal extends Controller {
    private $error = array();

    public function index() {
        $this->data = $this->load->language('total/total/total');
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('total/total/total', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        $this->data['action'] = $this->url->link('total/total/total', 'token=' . $this->session->data['token'], 'SSL');
