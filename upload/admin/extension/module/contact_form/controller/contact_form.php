...
class ControllerModuleContactFormContactForm extends Controller {
    ...
    public function index() {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('module/contact_form/contact_form', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        $this->data['action'] = $this->url->link('module/contact_form/contact_form', 'token=' . $this->session->data['token'], 'SSL');
