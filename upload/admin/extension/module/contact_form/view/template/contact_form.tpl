...
<div class="panel panel-default">
  <div class="panel-heading">
    <div class="pull-right">
      <button type="submit" form="form-contact-form" title="<?php echo $button_save; ?>" data-toggle="tooltip" class="btn btn-success">
  ...
  <div class="panel-body">
    <form method="post" action="<?php echo $action; ?>" id="form-contact-form" class="form-horizontal">
      <div class="form-group">
        <label class="required col-sm-2 control-label" for="input-receiving_email" data-toggle="tooltip" title="<?php echo $help_receiving_email; ?>"><?php echo $entry_receiving_email; ?>
          <i class="fa fa-question-circle"></i></label>
        <div class="col-sm-10">
          <textarea name="contact_form_receiving_email" id="input-receiving-email" class="form-control" placeholder="<?php echo $entry_receiving_email; ?>" rows="3"><?php echo $contact_form_receiving_email; ?></textarea>
        </div>
...
<script type="text/javascript"><!--
  $(document).ready(function () {
    ...
    )
    {
      ?
    >
      $('#input-description-<?php echo $language['
      language_id
      ']; ?>'
    ).
      summernote({
